...
class SessionProtobufHelper {
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, String str, int i, String str2, int i2, long j, long j2, boolean z, Map<C1492a, String> map, int i3, String str3, String str4) {
        ByteString copyFromUtf8 = ByteString.copyFromUtf8(str);
        ...
        for (Entry entry : map.entrySet()) {
            ...
            codedOutputStream.writeRawVarint32(getDeviceIdentifierSize((C1492a) entry.getKey(), (String) entry.getValue()));
            codedOutputStream.writeEnum(1, ((C1492a) entry.getKey()).f3740h);
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, Float f, int i2, boolean z, long j2, long j3) {
        ...
        if (byteStringForLog == null) {
            C1457c.m5546h().mo811a(CrashlyticsCore.TAG, "No log data to include with this event.");
        }
    ...
    private static int getDeviceIdentifierSize(C1492a c1492a, String str) {
        return CodedOutputStream.computeEnumSize(1, c1492a.f3740h) + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(str));
    }

    private static int getSessionDeviceSize(int i, ByteString byteString, ByteString byteString2, int i2, long j, long j2, boolean z, Map<C1492a, String> map, int i3, ByteString byteString3, ByteString byteString4) {
        int i4;
        int i5;
        ...
        if (map != null) {
            i5 = i4;
            for (Entry entry : map.entrySet()) {
                i4 = getDeviceIdentifierSize((C1492a) entry.getKey(), (String) entry.getValue());
