...
class DevicePowerStateListener {
    ...
    class C07111 extends BroadcastReceiver {
        C07111() {
        }
    ...
    class C07122 extends BroadcastReceiver {
        C07122() {
        }
    ...
    public DevicePowerStateListener(Context context) {
        ...
        this.powerConnectedReceiver = new C07111();
        this.powerDisconnectedReceiver = new C07122();
