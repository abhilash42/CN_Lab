...
public class DeviceTokenLoader implements C0677d<String> {
    ...
    L_0x0016:
        ...
        r2 = r2 / r4;
        r1 = io.fabric.sdk.android.C1457c.m5546h();
        r4 = "Beta";
    ...
    L_0x0045:
        r1 = move-exception;
        r2 = io.fabric.sdk.android.C1457c.m5546h();
        r3 = "Beta";
    ...
    L_0x0052:
        r2 = move-exception;
        r2 = io.fabric.sdk.android.C1457c.m5546h();	 Catch:{ all -> 0x00cc }
        r3 = "Beta";
        r6 = "Beta by Crashlytics app is not installed";
        r2.mo811a(r3, r6);	 Catch:{ all -> 0x00cc }
        if (r1 == 0) goto L_0x0016;
    L_0x0060:
    ...
    L_0x0071:
        ...
        r1 = r8;
    L_0x0075:
        r3 = io.fabric.sdk.android.C1457c.m5546h();	 Catch:{ all -> 0x00cf }
        r6 = "Beta";
        r7 = "Failed to find the APK file";
        r3.mo819e(r6, r7, r1);	 Catch:{ all -> 0x00cf }
