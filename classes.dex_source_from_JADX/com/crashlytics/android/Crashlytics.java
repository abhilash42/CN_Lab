...
import io.fabric.sdk.android.C0654i;
...
public class Crashlytics extends C0653h<Void> implements C0654i {
    public static final String TAG = "Crashlytics";
    public final Answers answers;
    public final Beta beta;
    public final CrashlyticsCore core;
    public final Collection<? extends C0653h> kits;
    ...
    Crashlytics(Answers answers, Beta beta, CrashlyticsCore crashlyticsCore) {
        ...
        this.beta = beta;
        this.core = crashlyticsCore;
        this.kits = Collections.unmodifiableCollection(Arrays.asList(new C0653h[]{answers, beta, crashlyticsCore}));
    }
    ...
    public Collection<? extends C0653h> getKits() {
        return this.kits;
    }
    ...
    public static Crashlytics getInstance() {
        return (Crashlytics) C1457c.m5538a(Crashlytics.class);
    }
    ...
    public void setDebugMode(boolean z) {
        C1457c.m5546h().mo816d(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        C1457c.m5546h().mo816d(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return C1457c.m5547i();
    }

    @Deprecated
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfoProvider) {
        C1457c.m5546h().mo816d(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
