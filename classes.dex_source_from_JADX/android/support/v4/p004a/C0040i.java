...
public final class C0040i {
    private static final Object f104f = new Object();
    private static C0040i f105g;
    private final Context f106a;
    private final HashMap<BroadcastReceiver, ArrayList<IntentFilter>> f107b = new HashMap();
    private final HashMap<String, ArrayList<C0039b>> f108c = new HashMap();
    private final ArrayList<C0038a> f109d = new ArrayList();
    private final Handler f110e;

    /* compiled from: LocalBroadcastManager */
    private static class C0038a {
        final Intent f99a;
        final ArrayList<C0039b> f100b;

        C0038a(Intent intent, ArrayList<C0039b> arrayList) {
            this.f99a = intent;
    ...
    private static class C0039b {
        final IntentFilter f101a;
        final BroadcastReceiver f102b;
        boolean f103c;

        C0039b(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f101a = intentFilter;
            this.f102b = broadcastReceiver;
        }

        public String toString() {
            StringBuilder stringBuilder = new StringBuilder(128);
            stringBuilder.append("Receiver{");
            stringBuilder.append(this.f102b);
    ...
    public static C0040i m106a(Context context) {
        C0040i c0040i;
        synchronized (f104f) {
            if (f105g == null) {
                f105g = new C0040i(context.getApplicationContext());
            }
            c0040i = f105g;
        }
        return c0040i;
    ...
    private C0040i(Context context) {
        this.f106a = context;
        this.f110e = new Handler(this, context.getMainLooper()) {
            final /* synthetic */ C0040i f98a;
    ...
    public void m110a(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f107b) {
            C0039b c0039b = new C0039b(intentFilter, broadcastReceiver);
            ArrayList arrayList = (ArrayList) this.f107b.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList(1);
                this.f107b.put(broadcastReceiver, arrayList);
            }
            arrayList.add(intentFilter);
            for (int i = 0; i < intentFilter.countActions(); i++) {
                String action = intentFilter.getAction(i);
                arrayList = (ArrayList) this.f108c.get(action);
                if (arrayList == null) {
                    arrayList = new ArrayList(1);
                    this.f108c.put(action, arrayList);
                }
    ...
    public void m109a(BroadcastReceiver broadcastReceiver) {
        synchronized (this.f107b) {
            ArrayList arrayList = (ArrayList) this.f107b.remove(broadcastReceiver);
            if (arrayList == null) {
                return;
            }
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                for (int i2 = 0; i2 < intentFilter.countActions(); i2++) {
                    ...
                    ArrayList arrayList2 = (ArrayList) this.f108c.get(action);
                    if (arrayList2 != null) {
                        int i3 = 0;
                        while (i3 < arrayList2.size()) {
                            int i4;
                            if (((C0039b) arrayList2.get(i3)).f102b == broadcastReceiver) {
    ...
    public boolean m111a(android.content.Intent r17) {
        /*
        r16 = this;
        r0 = r16;
        r13 = r0.f107b;
    ...
    L_0x0092:
        ...
        r0 = r1;
        r0 = (android.support.v4.p004a.C0040i.C0039b) r0;	 Catch:{ all -> 0x0103 }
        r9 = r0;
    ...
    L_0x009c:
        ...
        r14 = r9.f101a;	 Catch:{ all -> 0x0103 }
        r7 = r7.append(r14);	 Catch:{ all -> 0x0103 }
        r7 = r7.toString();	 Catch:{ all -> 0x0103 }
        android.util.Log.v(r1, r7);	 Catch:{ all -> 0x0103 }
    L_0x00b6:
        r1 = r9.f103c;	 Catch:{ all -> 0x0103 }
    ...
    L_0x013d:
        ...
        r1 = (android.support.v4.p004a.C0040i.C0039b) r1;	 Catch:{ all -> 0x0103 }
        r3 = 0;
        r1.f103c = r3;	 Catch:{ all -> 0x0103 }
        r1 = r2 + 1;
        r2 = r1;
        goto L_0x0137;
    L_0x014a:
        r0 = r16;
        r1 = r0.f109d;	 Catch:{ all -> 0x0103 }
        r2 = new android.support.v4.a.i$a;	 Catch:{ all -> 0x0103 }
        r0 = r17;
        r2.<init>(r0, r10);	 Catch:{ all -> 0x0103 }
        r1.add(r2);	 Catch:{ all -> 0x0103 }
        r0 = r16;
        r1 = r0.f110e;	 Catch:{ all -> 0x0103 }
        r2 = 1;
    ...
    L_0x000c:
        ...
        return;
    L_0x000e:
        r4 = new android.support.v4.p004a.C0040i.C0038a[r0];	 Catch:{ all -> 0x003f }
        r0 = r8.f109d;	 Catch:{ all -> 0x003f }
    ...
    L_0x002a:
        r0 = r5.f100b;
        r0 = r0.get(r1);
        r0 = (android.support.v4.p004a.C0040i.C0039b) r0;
        r0 = r0.f102b;
        r6 = r8.f106a;
        r7 = r5.f99a;
        r0.onReceive(r6, r7);
