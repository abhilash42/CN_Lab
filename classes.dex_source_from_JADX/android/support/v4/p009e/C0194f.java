...
public class C0194f<K, V> {
    ...
    L_0x000a:
        monitor-enter(r4);
        r0 = r4.f477a;	 Catch:{ all -> 0x002a }
        r0 = r0.get(r5);	 Catch:{ all -> 0x002a }
        if (r0 == 0) goto L_0x001b;
    L_0x0013:
        r1 = r4.f483g;	 Catch:{ all -> 0x002a }
        r1 = r1 + 1;
        r4.f483g = r1;	 Catch:{ all -> 0x002a }
        monitor-exit(r4);	 Catch:{ all -> 0x002a }
    L_0x001a:
        return r0;
    L_0x001b:
        r0 = r4.f484h;	 Catch:{ all -> 0x002a }
        r0 = r0 + 1;
        r4.f484h = r0;	 Catch:{ all -> 0x002a }
        monitor-exit(r4);	 Catch:{ all -> 0x002a }
        r1 = r4.m796b(r5);
    ...
    L_0x002d:
        monitor-enter(r4);
        r0 = r4.f481e;	 Catch:{ all -> 0x0053 }
        r0 = r0 + 1;
        r4.f481e = r0;	 Catch:{ all -> 0x0053 }
        r0 = r4.f477a;	 Catch:{ all -> 0x0053 }
        r0 = r0.put(r5, r1);	 Catch:{ all -> 0x0053 }
        if (r0 == 0) goto L_0x0049;
    L_0x003c:
        r2 = r4.f477a;	 Catch:{ all -> 0x0053 }
    ...
    L_0x0044:
        r2 = 0;
        r4.m794a(r2, r5, r1, r0);
        goto L_0x001a;
    L_0x0049:
        r2 = r4.f478b;	 Catch:{ all -> 0x0053 }
        r3 = r4.m790c(r5, r1);	 Catch:{ all -> 0x0053 }
        r2 = r2 + r3;
        r4.f478b = r2;	 Catch:{ all -> 0x0053 }
        goto L_0x0041;
    L_0x0053:
        r0 = move-exception;
        monitor-exit(r4);	 Catch:{ all -> 0x0053 }
    ...
    L_0x0056:
        ...
        goto L_0x001a;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.e.f.a(java.lang.Object):V");
    }
