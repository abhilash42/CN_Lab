...
import android.support.v4.p002b.p003a.C0004o;
...
abstract class C0005e extends Drawable implements C0004o {
    ...
    public void setHotspot(float f, float f2) {
        if (this.f12a != null) {
            C0150a.m656a(this.f12a, f, f2);
        }
    }

    public void setHotspotBounds(int i, int i2, int i3, int i4) {
        if (this.f12a != null) {
            C0150a.m658a(this.f12a, i, i2, i3, i4);
        }
    }
    ...
    public void jumpToCurrentState() {
        if (this.f12a != null) {
            C0150a.m655a(this.f12a);
        }
    }

    public void setAutoMirrored(boolean z) {
        if (this.f12a != null) {
            C0150a.m663a(this.f12a, z);
        }
    }

    public boolean isAutoMirrored() {
        if (this.f12a != null) {
            C0150a.m664b(this.f12a);
        }
        return false;
    }
    ...
    public void applyTheme(Theme theme) {
        if (this.f12a != null) {
            C0150a.m660a(this.f12a, theme);
        }
    }

    public int getLayoutDirection() {
        if (this.f12a != null) {
            C0150a.m669g(this.f12a);
        }
        return 0;
    }
