...
class C0010c {
    ...
    public static class C0009b {
        ...
        private C0009b(char c, float[] fArr) {
            this.f19a = c;
            this.f20b = fArr;
        }

        private C0009b(C0009b c0009b) {
            this.f19a = c0009b.f19a;
            this.f20b = C0010c.m18b(c0009b.f20b, 0, c0009b.f20b.length);
        }

        public static void m10a(C0009b[] c0009bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0009bArr.length; i++) {
                C0009b.m9a(path, fArr, c, c0009bArr[i].f19a, c0009bArr[i].f20b);
                c = c0009bArr[i].f19a;
            }
        }

        private static void m9a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            float f = fArr[0];
            float f2 = fArr[1];
            float f3 = fArr[2];
            ...
            while (i2 < fArr2.length) {
                ...
                switch (c2) {
                    case 'A':
                        ...
                        C0009b.m8a(path, f10, f9, f5, f2, f, f11, f12, z, z2);
                        f3 = fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6];
                        f6 = f7;
                        f5 = f8;
        ...
        private static void m8a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d10 < 0.0d) {
                ...
                C0009b.m8a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            d9 = Math.sqrt(d10);
            d5 *= d9;
            ...
            d = ((double) f5) * d6;
            d5 *= (double) f6;
            C0009b.m7a(path, (d * cos) - (d5 * sin), (d * sin) + (d5 * cos), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d4);
        }

        private static void m7a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
    ...
    private static float[] m18b(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    public static C0009b[] m15a(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            int a = C0010c.m11a(str, i);
            String trim = str.substring(i2, a).trim();
            if (trim.length() > 0) {
                C0010c.m13a(arrayList, trim.charAt(0), C0010c.m17b(trim));
            }
            i = a + 1;
            i2 = a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0010c.m13a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0009b[]) arrayList.toArray(new C0009b[arrayList.size()]);
    }

    public static C0009b[] m16a(C0009b[] c0009bArr) {
        if (c0009bArr == null) {
            return null;
        }
        C0009b[] c0009bArr2 = new C0009b[c0009bArr.length];
        for (int i = 0; i < c0009bArr.length; i++) {
            c0009bArr2[i] = new C0009b(c0009bArr[i]);
        }
        return c0009bArr2;
    }

    private static int m11a(String str, int i) {
        while (i < str.length()) {
    ...
    private static void m13a(ArrayList<C0009b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0009b(c, fArr));
    }

    private static float[] m17b(String str) {
    ...
    private static void m12a(java.lang.String r7, int r8, android.support.p000a.p001a.C0010c.C0008a r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.f18b = r1;
