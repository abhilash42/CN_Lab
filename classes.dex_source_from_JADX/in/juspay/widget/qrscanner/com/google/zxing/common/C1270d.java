...
public enum C1270d {
    ...
    private static final Map<Integer, C1270d> f2808B = null;
    private static final Map<String, C1270d> f2809C = null;
    ...
    static {
        f2808B = new HashMap();
        f2809C = new HashMap();
        for (C1270d c1270d : C1270d.values()) {
            for (int valueOf : c1270d.f2837D) {
                f2808B.put(Integer.valueOf(valueOf), c1270d);
            }
            f2809C.put(c1270d.name(), c1270d);
            for (Object put : c1270d.f2838E) {
                f2809C.put(put, c1270d);
            }
        }
    }

    private C1270d(int i) {
        this(r3, r4, new int[]{i}, new String[0]);
    }

    private C1270d(int i, String... strArr) {
        this.f2837D = new int[]{i};
        this.f2838E = strArr;
    }

    private C1270d(int[] iArr, String... strArr) {
        this.f2837D = iArr;
        this.f2838E = strArr;
    }
    ...
    public static C1270d m4874a(int i) {
        if (i >= 0 && i < 900) {
            return (C1270d) f2808B.get(Integer.valueOf(i));
        }
        throw FormatException.m4638a();
    }

    public static C1270d m4875a(String str) {
        return (C1270d) f2809C.get(str);
    }
}
