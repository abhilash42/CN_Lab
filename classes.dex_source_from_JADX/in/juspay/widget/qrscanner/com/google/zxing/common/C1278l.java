...
public final class C1278l {
    private static final String f2863a = Charset.defaultCharset().name();
    private static final boolean f2864b;

    static {
        boolean z = "SJIS".equalsIgnoreCase(f2863a) || "EUC_JP".equalsIgnoreCase(f2863a);
        f2864b = z;
    }

    public static String m4906a(byte[] bArr, Map<C1283d, ?> map) {
        Object obj;
        if (map != null) {
            if (map.containsKey(C1283d.CHARACTER_SET)) {
                return map.get(C1283d.CHARACTER_SET).toString();
            }
        }
        ...
        if (obj3 != null && (f2864b || i8 >= 3 || i11 >= 3)) {
            return "SJIS";
        }
